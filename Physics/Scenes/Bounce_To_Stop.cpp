...
void Bounce_To_Stop::Startup()
{
    ...
    Box* box = new Box(glm::vec2(50, -30), glm::vec2(0), glm::vec2(4), 1.f, 0.f, glm::vec4(0, 1, 0, 1), 0.3f);
    Box* box1 = new Box(glm::vec2(49, 0), glm::vec2(0), glm::vec2(4), 1.f, 0.f, glm::vec4(0, 0, 1, 1), 0.3f);
