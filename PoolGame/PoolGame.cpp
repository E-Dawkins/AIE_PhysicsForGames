...
void PoolGame::Startup(aie::Application* _app)
{
    ...
    m_cueBall->collisionCallback = std::bind(&PoolGame::CueBallCollision, this, std::placeholders::_1);
    AddActor(m_cueBall);
...
void PoolGame::Update(float _dt)
{
...
void PoolGame::MakeTriangle(glm::vec2 _startPos, float _spacing)
{
...
void PoolGame::PocketEnter(PhysicsObject* _other)
{
...
void PoolGame::CueBallCollision(PhysicsObject* _other)
{
